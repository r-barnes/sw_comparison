...
const QStringList ParametersLists::blastn_wordSize = QStringList() << "7"
                                                                   << "11"
                                                                   << "15";
const QStringList ParametersLists::blastp_wordSize = QStringList() << "2"
                                                                   << "3"
                                                                   << "6";
const QStringList ParametersLists::megablast_wordSize = QStringList() << "16"
                                                                      << "20"
                                                                      << "24"
                                                                      << "28"
                                                                      << "32"
                                                                      << "48"
                                                                      << "64";
const QStringList ParametersLists::blastn_gapCost = QStringList() << "4 4"
                                                                  << "2 4"
                                                                  << "0 4"
                                                                  << "3 3"
                                                                  << "5 2"
                                                                  << "4 2"
                                                                  << "2 2";
const QStringList ParametersLists::blastp_gapCost = QStringList() << "9 2"
                                                                  << "8 2"
                                                                  << "7 2"
                                                                  << "12 1"
                                                                  << "11 1"
...
const QStringList ParametersLists::blastn_scores = QStringList() << "1 -2"
                                                                 << "1 -3"
                                                                 << "1 -4"
                                                                 << "2 -3"
                                                                 << "4 -5"
...
const QStringList ParametersLists::blastp_matrix = QStringList() << "PAM30"
                                                                 << "PAM70"
                                                                 << "BLOSUM80"
                                                                 << "BLOSUM62"
                                                                 << "BLOSUM45";
...
const QStringList ParametersLists::cdd_dataBase = QStringList() << "CDD"
                                                                << "oasis_pfam"
                                                                << "oasis_smart"
                                                                << "oasis_cog"
                                                                << "oasis_kog"
