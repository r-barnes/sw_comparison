 ...
 * Header of Execution.
 */
#define HEADER PACKAGE_STRING"  -  CPU tool for huge sequences alignment"
...
int main ( int argc, char** argv ) {
	 ...
	 */
	return libmasa_entry_point(argc, argv, new SerialBlockAligner(new CPUBlockProcessor()), HEADER);
}
