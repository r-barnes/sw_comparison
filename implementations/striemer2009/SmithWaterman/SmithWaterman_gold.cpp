...
void
computeNumSeq( int* numSeq, char *database_Path) 
{
...
void
get_protein_lengths( int* proteinLengths, int* maxLen, char* database_Path, int* numSeq, unsigned int* total_Characters) 
{
...
void
create_Host_Array(char* database_Path, char** databaseArray)
{
int fileChar = 0;   //Contains ascii value of current character value
FILE* dataBaseFile;                             //Create a pointer to the file
dataBaseFile = fopen(database_Path, "r");       //Open the file for reading
...
void
Host_Array_2Dto1D(int* numSeq, int* proteinLengths, char** databaseArray, char* host_1D_Array)
{
...
void
Offset(int* proteinLengths, int* protein_Offset, int* numSeq, int* protein_length)
{
int i;
int k=0;
...
void
zeros_to_array(int* host_temp_array, int* numSeq)
{
...
void
write_Results(int* proteinLengths, char** databaseArray, char* Results_Path, int* numSeq, int* host_scores)
{
