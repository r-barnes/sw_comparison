...
#ifndef _TEMPLATE_KERNEL6_GLOBAL_H_
#define _TEMPLATE_KERNEL6_GLOBAL_H_
...
__device__ void loadPAM_6_64threads(const int &tid)
{
	...
	PAM_6(idxp, restp)				= blosum50[idxp][restp];	//riga 0,1
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 2,3
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 4,5
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 6,7
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 8,9
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 10,11
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 12,13
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 14,15
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 16,17
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 18,19
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 20,21
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 22,23
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 24,25
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 26,27
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 28,29
	idxp += 2; PAM_6(idxp, restp)	= blosum50[idxp][restp];	//riga 30,31
}
...
__global__ void sw_kernel6_global( const char* g_strToAlign, const unsigned sizeNotPad, const char* g_seqlib, unsigned seqOffset, unsigned *g_offsets, unsigned *g_sizes, unsigned alpha, unsigned beta, int *g_scores, int *d_colMemory) {
