...
/usr/local/cuda/bin/nvcc -o swhandler4_cu.o -c swhandler4.cu -Xcompiler "-m32" -Xcompiler "" -I. -I$QTINC -I/usr/local/cuda/include -I/usr/local/cuda/SDK/common/inc -DUNIX -O3
...
/usr/local/cuda/bin/nvcc -o swhandlerprof_cu.o -c swhandlerprof.cu -Xcompiler "-m32" -Xcompiler "" -I. -I$QTINC -I/usr/local/cuda/include -I/usr/local/cuda/SDK/common/inc -DUNIX -O3

echo ""
echo "Compiling Est2Genome - Solexa ...."
echo ""
# SCAN implementation of GEAGpu
/usr/local/cuda/bin/nvcc -o e2g_hndlscan.o -c e2g_hndlscan.cu -arch="compute_11" -code="compute_11" -Xcompiler "-m32" -Xcompiler "" -I. -I$QTINC -I/usr/local/cuda/include -I/usr/local/cuda/SDK/common/inc -DUNIX -O3
