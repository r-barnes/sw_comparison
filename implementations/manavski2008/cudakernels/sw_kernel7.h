...
#ifndef _TEMPLATE_KERNEL7_H_
#define _TEMPLATE_KERNEL7_H_
...
__device__ void loadPAM_7_64threads(const int &tid)
{
	...
	PAM_7(idxp, restp)				= blosum50_7[idxp*32+restp];	//riga 0,1
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 2,3
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 4,5
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 6,7
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 8,9
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 10,11
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 12,13
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 14,15
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 16,17
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 18,19
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 20,21
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 22,23
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 24,25
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 26,27
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 28,29
	idxp += 2; PAM_7(idxp, restp)	= blosum50_7[idxp*32+restp];	//riga 30,31
}
...
__global__ void sw_kernel7( const char* g_strToAlign, const unsigned sizeNotPad, const char* g_seqlib, unsigned seqOffset, unsigned *g_offsets, unsigned *g_sizes, unsigned alpha, unsigned beta, int *g_scores) {
...
__global__ void sw_kernel7_with_endpos( const char* g_strToAlign, const unsigned sizeNotPad, const char* g_seqlib, unsigned seqOffset, unsigned *g_offsets, unsigned *g_sizes, unsigned alpha, unsigned beta, int *g_scores, unsigned *dev_endpos) {
