...
query=datasets/seq_1K_300_a
ref=datasets/seq_1K_300_b
...
echo "Liu2013 qprf 1"
./build/implementations/liu2013/cudasw3 -qprf 1 -gapo 6 -gape 1 -mat blosum50 -query $query -db $ref
...
#TODO: Requires preprocessed input
echo "Rognes2011"
threads=1
#TODO
...
echo "Sjoluand2016"
threads=1
#Sequences first sequence from input query file against all sequences in database file
./build/implementations/sjolund2016/src/c/diagonalsw --matrixfile implementations/sjolund2016/src/docbook/example_files/blosum50.mat -i -6 -e -1 -t $threads -q $query -d $ref

echo "Striemer2009"
#Runs query string one at a time against database
#Same result regardless of whether or not it has a query file
